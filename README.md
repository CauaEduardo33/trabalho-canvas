...
* Aperta-se
## Modo de um jogador
O modo *singler player* é um modo de arremesso livre infinito.

## Modo de dois jogadores
O modo *multiplayer* funciona em turnos. Quando um jogador erra a cesta, ele passa a vez para o outro. O jogador que fizer 10 pontos primeiro ganha.
